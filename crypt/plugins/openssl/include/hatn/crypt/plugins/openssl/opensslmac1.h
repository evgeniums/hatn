...
/****************************************************************************/
/** @file crypt/plugins/openssl/opensslhmac1.h
 *
 * 	HMAC (Hash Message Authentication Code) implementation with OpenSSL backend before openssl 3.0
 *
 */
/****************************************************************************/

#ifndef HATNOPENSSLMAC1_H
#define HATNOPENSSLMAC1_H
