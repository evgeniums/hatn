...
HDU_UNIT(account_config,
    HDU_FIELD(valid_till,TYPE_DATETIME,1)
    HDU_FIELD(user_name,TYPE_STRING,2)
    HDU_FIELD(server_name,TYPE_STRING,3)
    HDU_FIELD(server_id,TYPE_STRING,4)
    HDU_FIELD(server_root_certificate,TYPE_STRING,5)
    HDU_REPEATED_FIELD(server_certificate_chain,TYPE_STRING,6)
    HDU_FIELD(user_token,TYPE_BYTES,7)
    HDU_REPEATED_FIELD(server_route,server_route_hop::TYPE,8)
)
